...
$checks = array(
    ...
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:NumberOfEntries)' => '22',
    ...
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:Journal/saf:Transaction[saf:TransactionID="DK-991004"]/saf:Line[saf:AccountID="4000"]/saf:TaxInformation/saf:TaxCode)' => 'DKBUY25',
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:Journal/saf:Transaction[saf:TransactionID="DK-991004"]/saf:Line[saf:AccountID="4000"]/saf:TaxInformation/saf:TaxBase)' => '200.00000000',
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:Journal/saf:Transaction[saf:TransactionID="DK-991004"]/saf:Line[saf:AccountID="4000"]/saf:TaxInformation/saf:TaxAmount/saf:Amount)' => '50.00000000',
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:Journal/saf:Transaction[saf:TransactionID="DK-991005"]/saf:Line[saf:AccountID="3000"]/saf:TaxInformation/saf:TaxCode)' => 'DKSALE0',
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:Journal/saf:Transaction[saf:TransactionID="DK-991005"]/saf:Line[saf:AccountID="3000"]/saf:TaxInformation/saf:TaxPercentage)' => '0.00000000',
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:Journal/saf:Transaction[saf:TransactionID="DK-991005"]/saf:Line[saf:AccountID="3000"]/saf:TaxInformation/saf:TaxAmount/saf:Amount)' => '0.00000000',
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:Journal/saf:Transaction[saf:TransactionID="DK-991006"]/saf:Line[saf:AccountID="3000"]/saf:TaxInformation/saf:TaxCode)' => 'DKTEST25',
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:Journal/saf:Transaction[saf:TransactionID="DK-991006"]/saf:Line[saf:AccountID="3000"]/saf:TaxInformation/saf:TaxBase)' => '-100.00000000',
    'string(/saf:AuditFile/saf:GeneralLedgerEntries/saf:Journal/saf:Transaction[saf:TransactionID="DK-991006"]/saf:Line[saf:AccountID="3000"]/saf:TaxInformation/saf:TaxAmount/saf:Amount)' => '-25.00000000',
);
